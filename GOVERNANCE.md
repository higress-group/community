...
- **Code owner**: a contributor delegated to review changes in one or more
  paths in the relevant repository's `CODEOWNERS`, including the
  [primary repository ownership rules](https://github.com/higress-group/higress/blob/main/CODEOWNERS).
  Code owners assess technical quality,
...
| --- | --- | --- |
| [`higress-group/community`](https://github.com/higress-group/community) | Project-wide governance, community meetings, maintainer and adopter information, roadmap process, and CNCF review materials | Active project infrastructure; not a software subproject |
...
Git submodules declared in the primary repository's
[`.gitmodules`](https://github.com/higress-group/higress/blob/main/.gitmodules),
including the
...
defined in the
[Higress security policy](https://github.com/higress-group/higress/blob/main/SECURITY.md).
...
Security reporting and response follow the
[Higress security policy](https://github.com/higress-group/higress/blob/main/SECURITY.md).
