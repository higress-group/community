...
- **Review state:** Project self-assessment approved in
  ...
  pending
- **Evidence branches:**
  [`higress-group/community@main`](https://github.com/higress-group/community/tree/main)
  for project-wide governance material, and
  [`higress-group/higress@main`](https://github.com/higress-group/higress/tree/main)
  for repository-specific evidence
...
- [`README.md`](https://github.com/higress-group/community/blob/main/README.md)
- Git history in this repository and the pre-migration history for governance,
  maintainer, and ownership files in
