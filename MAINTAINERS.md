...
see the `CODEOWNERS` file in the relevant repository, including the
...
More specific day-to-day review responsibilities are delegated through each
repository's `CODEOWNERS`; they do not narrow a maintainer's project-wide
responsibility.
...
* For security issues, please follow the
...
* For all other questions, please use
  ...
  community channels listed in [`COMMUNITY.md`](./COMMUNITY.md).
